          ...
          <main>
            <div className="main-box">
              <div className="cover-box">
                <span>이용약관</span>
                <div className="scroll-box">{usePolicy}</div>
              </div>
              <div className="cover-box">
                <span>개인정보 처리방침</span>
                <div className="scroll-box">{privacyPolicy}</div>
              </div>
            </div>
          </main>
          <footer>
